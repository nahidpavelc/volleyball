    ...
    <div class="col-md-12">
      ...
      <div class="box box-teal box-solid">
        <div class="box-header with-border">
          <h3 class="box-title"><?php echo $this->lang->line('match_edit'); ?> </h3>
          <div class="box-tools pull-right">
            <a href="<?php echo base_url() ?>admin/match_edit/list" type="submit" class="btn bg-purple btn-sm" style="color: white;"> <i class="fa fa-list"></i> <?php echo $this->lang->line('match_list'); ?> </a>
          </div>
        </div>
        <div class="box-body">
          <div class="row">

            <form action="<?php echo base_url("admin/match/edit/" . $match_list->id); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <input name="name_bn" value="<?php echo $match_list->name_bn; ?>" placeholder="<?php echo $this->lang->line('name_bn'); ?> " class="form-control inner_shadow_teal" required="" type="text">
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <input name="name_en" value="<?php echo $match_list->name_en; ?>" placeholder="<?php echo $this->lang->line('name_en'); ?> " class="form-control inner_shadow_teal" required="" type="text">
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <input name="father_name" value="<?php echo $match_list->father_name; ?>" placeholder="<?php echo $this->lang->line('father_name'); ?> " class="form-control inner_shadow_teal" required="" type="text">
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <input name="phone" value="<?php echo $match_list->phone; ?>" placeholder="<?php echo $this->lang->line('phone'); ?> " class="form-control inner_shadow_teal" required="" type="text">
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <input name="birth_date" value="<?php echo $match_list->birth_date; ?>" id="date" placeholder="<?php echo $this->lang->line('birth_date'); ?> " class="form-control inner_shadow_teal " required="" type="text">
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <input name="nid_card" value="<?php echo $match_list->nid_card; ?>" placeholder="<?php echo $this->lang->line('nid_card'); ?> " class="form-control inner_shadow_teal" required="" type="number">
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <input name="email" value="<?php echo $match_list->email; ?>" placeholder="<?php echo $this->lang->line('email'); ?> " class="form-control inner_shadow_teal" required="" type="text">
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <input name="facebook_url" value="<?php echo $match_list->facebook_url; ?>" placeholder="<?php echo $this->lang->line('facebook_url'); ?> " class="form-control inner_shadow_teal" required="" type="url">
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <input name="live_interview_link" value="<?php echo $match_list->live_interview_link; ?>" placeholder="<?php echo $this->lang->line('live_interview_link'); ?> " class="form-control inner_shadow_teal" required="" type="url">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="box box-teal" style="margin-left: 15px;">
                      ...
                      <div class="box-body box-profile">
                        <center>
                          <img id="match_photo" class="img-responsive" src="<?= base_url('assets/preview.png'); ?>" alt="profile picture" style="max-width:80; width: 100px; height: 100px;"><small style="color: gray">width : 400px, Height : 400px</small>
                          <br>
                  ...
                  <div class="col-md-4">
                    <div class="box box-teal" style="margin-left: 15px;">
                      ...
                      <div class="box-body box-profile">
                        <center>
                          <img id="nid_photo" class="img-responsive" src="<?php echo base_url($match_list->photo); ?>" alt="profile picture" style="max-width:80; width: 100px; height: 100px;"><small style="color: gray">width : 400px, Height : 400px</small>
                          <br>
                    ...
                    <div class="col-sm-12">
                      ...
                      <select name="pre_division_id" id="pre_division_id" class="form-control select2">
                        <?php foreach ($divissions as $key => $value) { ?>
                          <option value="<?php echo $value->id ?>" <?php if ($match_list->pre_division_id == $value->id) echo "selected" ?>><?php echo $value->name ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-12">
                      ...
                      <select name="pre_zilla_id" id="pre_zilla_id" class="form-control select2">
                        <?php foreach ($zilla as $key => $value) { ?>
                          <option value="<?php echo $value->id ?>" <?php if ($match_list->pre_zilla_id == $value->id) echo "selected" ?>><?php echo $value->name ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-12">
                      ...
                      <select name="pre_upozilla_id" id="pre_upozilla_id" class="form-control select2">
                        <?php foreach ($upozilla as $key => $value) { ?>
                          <option value="<?php echo $value->id ?>" <?php if ($match_list->pre_upozilla_id == $value->id) echo "selected" ?>><?php echo $value->name ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <input name="pre_village_road" value="<?php echo $match_list->pre_village_road; ?>" placeholder="<?php echo $this->lang->line('pre_village_road'); ?> " class="form-control inner_shadow_teal" required="" type="text">
                    </div>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <select name="par_division_id" id="par_division_id" class="form-control select2">
                        <?php foreach ($divissions as $key => $value) { ?>
                          <option value="<?php echo $value->id ?>" <?php if ($match_list->par_division_id == $value->id) echo "selected" ?>><?php echo $value->name ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <select name="par_zilla_id" id="par_zilla_id" class="form-control select2">
                        <?php foreach ($zilla as $key => $value) { ?>
                          <option value="<?php echo $value->id ?>" <?php if ($match_list->par_zilla_id == $value->id) echo "selected" ?>><?php echo $value->name ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <select name="par_upozilla_id" id="par_upozilla_id" class="form-control select2">
                        <?php foreach ($upozilla as $key => $value) { ?>
                          <option value="<?php echo $value->id ?>" <?php if ($match_list->par_upozilla_id == $value->id) echo "selected" ?>><?php echo $value->name ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <input name="par_village_road" value="<?php echo $match_list->par_village_road; ?>" placeholder="<?php echo $this->lang->line('par_village_road'); ?> " class="form-control inner_shadow_teal" required="" type="text">
                    </div>
                  </div>
                </div>
